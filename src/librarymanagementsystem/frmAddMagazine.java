 ...
 * @author tchhay
 */
public class frmAddMagazine extends javax.swing.JFrame {

    /**
     * Creates new form frmAddMagazine
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddMagazine.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAddMagazine().setVisible(true);
            }
        });
    }
